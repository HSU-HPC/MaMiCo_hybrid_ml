...
if __name__ == "__main__":
    ...
    _files = [
        f'{_directory}{_model_name}Valid_Error_Timeline_C_3_0_B.csv',
        f'{_directory}{_model_name}Valid_Error_Timeline_C_3_0_M.csv',
        f'{_directory}{_model_name}Valid_Error_Timeline_C_3_0_T.csv',
        f'{_directory}{_model_name}Valid_Error_Timeline_C_5_0_B.csv',
        f'{_directory}{_model_name}Valid_Error_Timeline_C_5_0_M.csv',
        f'{_directory}{_model_name}Valid_Error_Timeline_C_5_0_T.csv'
    ]
    _labels = [
        'C 3 0 B',
        'C 3 0 M',

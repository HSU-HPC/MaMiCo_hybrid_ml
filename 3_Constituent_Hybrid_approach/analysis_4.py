...
def train_AE_MSLE(loader, model, optimizer, criterion, scaler, model_identifier, current_epoch):
...
def analysis_4_KVS_non_UNET_mp():
    """The analysis_4_KVS_non_UNET_mp function is essentially a helper
    function to facilitate the training of various AE model configurations
    on the basis of the KVS based data distribution.
